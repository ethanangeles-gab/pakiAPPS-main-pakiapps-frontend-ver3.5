...
import { COLORS, quickTags } from '@features/customer/data';
...
const reviewMascot = require('../../../../assets/logoutMascot.png');
        ...
        <ScrollView contentContainerStyle={styles.reviewContent} showsVerticalScrollIndicator={false}>
          <View style={styles.reviewFormCard}>
            <View style={styles.reviewPromptHeader}>
              ...
              <View style={styles.flexOne}>
                <Text style={styles.reviewQuestion}>How was your stay?</Text>
                <Text style={styles.reviewHelp}>Your review helps the community find the best spots.</Text>
              </View>
            </View>

            <View style={styles.reviewRatingBox}>
              {rating > 0 ? <Image source={reviewMascot} style={styles.reviewRatingMascot} resizeMode="contain" /> : null}
...
const styles = StyleSheet.create({
  ...
  reviewRatingMascot: { width: 122, height: 122, marginBottom: -10 },
  reviewRatingLabel: { color: COLORS.text, fontSize: 11, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.4 },
